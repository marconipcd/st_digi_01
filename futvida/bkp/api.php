...
function cadastrarCliente($txtCpfTitularContrato,
    $txtNomeTitularContrato,$txtCpfAluno,$txtNomeAluno,$txtDataNascimento,$txtEndereco,$txtBairro,
    $txtCidade,$txtFone,$txtEmail,$cbHorario){

    $con = new mysqli("172.17.0.11", "marconi", "idigital123mc", "db_opus");
    if (mysqli_connect_errno()) trigger_error(mysqli_connect_error());

    $query = sprintf("INSERT INTO clientes NOME_RAZAO VALUES ", $cpf);
...
function procurar_cliente_cpf($cpf){
    ...
    $query = sprintf("SELECT  ac.ID AS COD_CONTRATO, c.ID, c.NOME_RAZAO, c.DATA_NASCIMENTO, ep.CEP, ep.ENDERECO, ep.NUMERO, ep.COMPLEMENTO, 
