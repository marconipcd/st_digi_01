<?php
    ...
    function buscarBoletos($codContrato){
       $con = new mysqli("172.17.0.11", "marconi", "idigital123mc", "db_opus");
        ...
        $rBoletosProrata = "^".$codContrato."/PRORATA";
      

        $query = sprintf("select ID, N_DOC, VALOR_TITULO, DATA_VENCIMENTO, BLOQUEADO,STATUS_2 from contas_receber cr where cr.status_2 ='ABERTO' and cr.n_doc REGEXP '%s' OR cr.status_2 ='ABERTO' and cr.n_doc REGEXP '%s' OR cr.status_2 ='ABERTO' and cr.n_doc REGEXP '%s'",$rNovo, $rBoletoInst,$rBoletosProrata);
