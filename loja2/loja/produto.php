                            ...
                            <div class="inferior row-fluid ">
                                <div class="span8 busca-mobile" style="width:100%;">
                                    ...
                                    <div class="busca borda-alpha">
                                        <form id="form-buscar" action="https://loja.digitalonline.com.br/buscar" method="get">
                        ...
                        <ul class="nivel-um">
                            <li class="categoria-id-4529461  borda-principal">
                                <a href="#" title="acessórios">
                                    <strong class="titulo cor-secundaria">acessórios
                                    </strong>
                            ...
                            <li class="categoria-id-4631618  borda-principal">
                                <a href="#" title="CADEIRAS">
                            ...
                            <li class="categoria-id-4529471  borda-principal">
                                <a href="#" title="eletrônicos">
                            ...
                            <li class="categoria-id-4529468  borda-principal">
                                <a href="#" title="escritório">
                            ...
                            <li class="categoria-id-4529464  borda-principal">
                                <a href="#" title="gamers">
                            ...
                            <li class="categoria-id-4529473  borda-principal">
                                <a href="#" title="internet">
                            ...
                            <li class="categoria-id-4529491  borda-principal">
                                <a href="#" title="outros">
                            ...
                            <li class="categoria-id-4529463  borda-principal">
                                <a href="#" title="periféricos">
                                                ...
                                                ?>
                                                    ...
                                                    <li class="span3">
                                                        <div class="listagem-item " itemprop="isRelatedTo" itemscope="itemscope" itemtype="http://schema.org/Product">
                                                            <a href="produto.php?p=<?php echo $p->ID; ?>" class="produto-sobrepor" title="FONE DE OUVIDO HEADSET FLOW BRANCO, OEX HS207" itemprop="url"></a>
                                                            ...
                                                            <div class="acoes-produto hidden-phone">
                                                                <a href="fone-de-ouvido-headset-flow-branco-oex-hs207.html" title="Ver detalhes do produto" class="botao botao-comprar principal">
                                                                    <i class="icon-search"></i>Ver mais
                                                                </a>
                                                            </div>
                                                            <div class="acoes-produto-responsiva visible-phone">
                                                                <a href="fone-de-ouvido-headset-flow-branco-oex-hs207.html" title="Ver detalhes do produto" class="tag-comprar fundo-principal">
...
<!--
                                    <div class="span4 links-rodape links-rodape-categorias">
                                        ...
                                        <ul class=" total-itens_8">
                                            ...
                                            <li>
                                                <a href="categoria/acessorios.html">
                                                    acessórios
                                            ...
                                            <li>
                                                <a href="categoria/cadeiras.html">
                                                    CADEIRAS
                                                </a>
                                            </li>
                                            ...
                                            <li>
                                                <a href="categoria/eletronicos.html">
                                                    eletrônicos
                                                </a>
                                            </li>
                                            ...
                                            <li>
                                                <a href="categoria/escritorio.html">
                                                    escritório
                                                </a>
                                            </li>
                                            ...
                                            <li>
                                                <a href="categoria/internet.html">
                                                    internet
                                                </a>
                                            </li>
                                            ...
                                            <li>
                                                <a href="categoria/perifericos.html">
                                                    periféricos
                                                </a>
                                            </li>
                    ...
                    <div class="span6">
                        <div class="row-fluid">
                            <div class="busca borda-alpha span6">
                                <form action="https://loja.digitalonline.com.br/buscar" method="get">
        ...
        <div id="modalContato" class="modal hide" tabindex="-1" aria-labelledby="modalContatoLabel" aria-hidden="true">
            ...
            <form action="https://loja.digitalonline.com.br/contato/popup/" method="post" class="form-horizontal">
        ...
        <div id="avise-me-cadastro" style="display: none;">
            ...
            <div class="avise-me">
                <form action="https://loja.digitalonline.com.br/espera/produto/47233202/assinar/" method="POST" class="avise-me-form">
