...
var login = new Vue({
    ...
    data:{
        mostrarFormIndicacao: false,
        mostrar_erro_login: false,
        mostrar_erro_login_null: false,
        mostrarLogin: true,
        mostrarConfirmacaoEnviado: false,
        cliente_selecionado:[],
        contratos:[],
        indicacoes:[],
    ...
    methods:{
        ...
        enviarIndicacao(){
                ...
                $.ajax({
                    ...
                    success: function(r){
                        ...
                        //console.log(r);
                        login.buscarIndicacoes();
                        login.$data.mostrarFormIndicacao=false;
                        login.$data.mostrarConfirmacaoEnviado=true;
                        $(document).animate({scrollTop: $('#indicacoes').scrollTop()}, 500);
                    },
                    error: function(e){
                        login.buscarIndicacoes();
                        login.$data.mostrarFormIndicacao=false;
        ...
        novaIndicacao(){
            login.$data.mostrarFormIndicacao=true;
        },

        enviarIndicacaoVoltar(){
            login.$data.mostrarFormIndicacao=false;
        },
