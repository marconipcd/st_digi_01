...
function listarCategorias(){
    ...
    $cURLConnection = curl_init('http://179.127.32.7:8989/loja_virtual/listar_categorias.php');
...
function listarProdutosBusca($s){
    
    $parametros = "s=".$s;

    $cURLConnection = curl_init('http://179.127.32.7:8989/loja_virtual/listar_produtos_buscar.php');
    curl_setopt($cURLConnection, CURLOPT_POST, 1);
...
function listarProdutosPorCategoria($categoria){
    ...
    $cURLConnection = curl_init('http://179.127.32.7:8989/loja_virtual/listar_produtos_por_categoria.php');
    curl_setopt($cURLConnection, CURLOPT_POST, 1);
    curl_setopt($cURLConnection, CURLOPT_POSTFIELDS, $parametros);
    curl_setopt($cURLConnection, CURLOPT_RETURNTRANSFER, true);
    curl_setopt($cURLConnection, CURLOPT_HTTPHEADER, array(
...
function cadastrarEmail($email){
    ...
    $cURLConnection = curl_init('http://179.127.32.7:8989/loja_virtual/cadastrar_email.php');
    curl_setopt($cURLConnection, CURLOPT_POST, 1);
    curl_setopt($cURLConnection, CURLOPT_POSTFIELDS, $parametros);
    curl_setopt($cURLConnection, CURLOPT_RETURNTRANSFER, true);
    curl_setopt($cURLConnection, CURLOPT_HTTPHEADER, array(
