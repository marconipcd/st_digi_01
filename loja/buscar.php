                        ...
                        <div class="row-fluid ">
                            <div id="listagemProdutos" class="listagem borda-alpha com-caixa">
                                <div class="titulo-categoria borda-principal cor-principal vitrine-destaque">
                                    <strong>buscando por: <?php if(isset($_REQUEST['s'])){ echo $_REQUEST['s']; } ?></strong>
                                </div>
                                ...
                                <ul data-produtos-linha="4">
                                    ...
                                    $p1 = listarProdutosBusca($_REQUEST['s']);
                                   // echo $p1;
                    ...
                    <div class="row-fluid">
                        <div class="busca borda-alpha span6">
                            <form action="buscar.php" method="get">
                                <input type="text" name="s" placeholder="Digite o que você procura" value="<?php if(isset($_REQUEST['s'])){ echo $_REQUEST['s'];} ?>" />
