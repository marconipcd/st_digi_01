...
if (isset($_REQUEST['c'])) {
    ...
    $p1 = listarProdutosPorCategoria($categoria);
...
<!-- Mirrored from loja.digitalonline.com.br/categoria/4529461.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 May 2021 18:26:53 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title>acessórios - LOJADIGITALONLINE
    </title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="generator" content="Loja Integrada" />


    <meta property="og:url" content="4529461.html" />
    ...
    <link rel="canonical" href="acessorios.html" />



    <meta property="og:title" content="LOJADIGITALONLINE" />

    <meta property="og:image" content="../../cdn.awsli.com.br/962/962506/logo/c06c85177e.png" />
...
">
    ...
    <link rel="next" href="acessorios90ff.html?pagina=2">
    ...
    <script>
        ...
        ga('set', 'ecomm_prodid', '55078609, 45624647, 58564287, 57201414, 47611971, 58268957, 47182873, 58564051, 58564186, 58563944, 58564088, 46268902, 45606493, 45607224, 46716527, 46353811, 46714633, 46664720, 46714627, 46468929, 46468865, 45608108, 46664680, 47329679, 68459648, 61285505, 46663441, 46714618, 46716567, 46470097, 47330305, 47010796, 45628013, 46664376, 46468824, 46370466, 46152333, 47615797, 46153764, 46716476');
...
<body class="pagina-categoria categoria-4529461   " data-spy="scroll" data-target=".navegacao" ontouchstart="">
    <div id="fb-root"></div>
            ...
            <div class="conteiner">           
                ...
                <div class="breadcrumbs borda-alpha ">
                    <ul>
                        ...
                        <li>
                            <strong class="cor-secundaria"><?php echo $_REQUEST['n']; ?>
                            </strong>
                        </li>
                    </ul>
                </div>
                ...
                <div class="secao-principal row-fluid sem-coluna">
                    ...
                    <div class="coluna span3 ">
                        ...
                        <div class="lateral outras filtro-coluna faceta-preco">
                            <div class="filtro lista borda-principal" data-toggle="tooltip" data-placement="right" title="">
                                ...
                                <div class="borda-alpha">
                                    <ul>
                                        <li class="">
                                            <a href="45294613278.html?fq=Preco:1.0%2F24.99" rel="nofollow">
                                                <label>
                                                    de R$ 1,00
                                                    até R$ 24,99
                                                    <small>(16)</small>
                                        ...
                                        <li class="">
                                            <a href="45294614b51.html?fq=Preco:25.0%2F49.99" rel="nofollow">
                                                <label>
                                                    de R$ 25,00
                                                    até R$ 49,99
                                                    <small>(18)</small>
                                        ...
                                        <li class="">
                                            <a href="4529461577c.html?fq=Preco:50.0%2F69.99" rel="nofollow">
                                                <label>
                                                    de R$ 50,00
                                                    até R$ 69,99
                                                    <small>(7)</small>
                                        ...
                                        <li class="">
                                            <a href="45294610ef9.html?fq=Preco:70.0%2F99.99" rel="nofollow">
                                                <label>
                                                    de R$ 70,00
                                                    até R$ 99,99
                                                    <small>(8)</small>
                                        ...
                                        <li class="">
                                            <a href="4529461de3a.html?fq=Preco:100.0%2F199.99" rel="nofollow">
                                                <label>
                                                    de R$ 100,00
                                                    até R$ 199,99
                                                    <small>(11)</small>
                    ...
                    <div class="conteudo span9">
                                        ...
                                        <div class="input-append">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    <li><a href="4529461ba88.html?sort=%2Bnome" rel="nofollow"><i class="icon-font" style="margin-left: -3px; margin-right: 9px;"></i>Ordem alfabética</a></li>
                                                    <li><a href="4529461bb7d.html?sort=mais_vendidos" rel="nofollow"><i class="icon-shopping-cart" style="margin-left: -3px; margin-right: 9px;"></i>Mais vendidos</a></li>
                                                    <li><a href="4529461a6d4.html?sort=%2Bpreco" rel="nofollow"><i class="icon-dollar"></i>Menor preço</a></li>
                                                    <li><a href="4529461c25e.html?sort=-preco" rel="nofollow"><i class="icon-dollar"></i>Maior preço</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <h1 class="titulo cor-secundaria"><?php echo $_REQUEST['n']; ?></h1>
                            ...
                            <ul data-produtos-linha="4">
                                <li class="listagem-linha">
                                    <ul class="row-fluid">
                                        ...
                                        <li class="span3">
                                            <div class="listagem-item prod-id-55078609  prod-cat-4529461">
                                                <a href="../produto.php?p=<?php echo $p->ID; ?>" class="produto-sobrepor" title="<?php echo substr($p->NOME, 0, 40) . "..."; ?>"></a>
                                                <div class="imagem-produto has-zoom">
                                                    <img src="../fotos_produtos/<?php echo $p->ENDERECO_FOTO; ?>" alt="<?php echo substr($p->NOME, 0, 40) . "..."; ?>" class="imagem-principal" data-imagem-caminho="../fotos_produtos/<?php echo $p->ENDERECO_FOTO; ?>" />
                                                </div>
                                                <div class="info-produto">
                                                    <a href="../produto.php?p=<?php $p->ID; ?>" class="nome-produto cor-secundaria"><?php echo substr($p->NOME, 0, 40) . "..."; ?></a>
                                                    <div class="produto-sku hide">15896</div>
                                                    <div data-trustvox-product-code="55078609" class="hide trustvox-stars"></div>
                                                    <div>
                                ...
                                <div class="carrinho-interno-ajax">
                                    ...
                                    <div class="carrinho-interno borda-principal">
                                        ...
                                        <div class="carrinho-rodape">
                                            ...
                                            <a href="../carrinho/index.html" class="botao principal">
